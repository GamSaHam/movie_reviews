...
class Slider extends Component {
  ...
  renderCarouselItemMdSize = movie => {
    return (
      <div>
        <div className="row">
          {this.renderMovieCard(movie[0])}
          {this.renderMovieCard(movie[1])}
        </div>
        <div className="row">
          {this.renderMovieCard(movie[2])}
          {this.renderMovieCard(movie[3])}
        </div>
        <div className="row">
          {this.renderMovieCard(movie[4])}
          {this.renderMovieCard(movie[5])}
        </div>
        <div className="row">
          {this.renderMovieCard(movie[6])}
          {this.renderMovieCard(movie[7])}
        </div>
        <div className="row">
          {this.renderMovieCard(movie[8])}
          {this.renderMovieCard(movie[9])}
        </div>
      </div>
    );
  };
  ...
  render() {
    return (
      <div>
        <div className="container pt-5 pb-5  d-block d-lg-none">
          <h1>이달의 영화랭킹</h1>
          <hr />
          <div className="pt-5 pb-5 slider-bg ">
            ...
            >
              ...
              <div className="carousel-inner">
                ...
                >
                  {this.renderCarouselItemMdSize(this.state.bestRatingMovies)}
                </div>
                ...
                <div
                  ...
                  style={{ width: '100%', height: '1600px' }}
                >
                  {this.renderCarouselItemMdSize(this.state.bestViewsMovies)}
                </div>
                <div
                  className="carousel-item pl-5 pr-5"
                  style={{ width: '100%', height: '1600px' }}
                >
                  {this.renderCarouselItemMdSize(this.state.bestRecentMovies)}
                </div>
              </div>
        ...
        <div className="container pt-5 pb-5  d-none d-lg-block">
          <h1>이달의 영화랭킹</h1>
          <hr />
          <div className="pt-5 pb-5 slider-bg ">
            <div
